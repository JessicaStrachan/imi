...
<section class="container">
	...
	<div class="form-tabs">
		<button class="form-tabs__button btn--tabs btn btn--secondary js-contact-tab tab-active">Contact</button>
    ...
    <div id="respond">
        <?php echo $response; ?>
        <form class="form grid js-contact-form form--active" action="<?php the_permalink(); ?>" method="post">
            <div class="form__row">
                <div class="col-6">
