...
<div class="container container--header-top">
  <h1 class="heading--one heading--bold heading--primary u-align-center heading--space-bottom-large">Events</h1>
      ...
      <div <?php post_class() ?> >
        <a class="card__link" href="<?php the_permalink(); ?>">
          ...
          <div class="card__info">
            ...
            <p class="card__details"><?php echo $event->field('event_date_text'); ?> </br>
